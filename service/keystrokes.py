...
_KEY_ACTION_PHRASES_DICT = {
    ...
    "Next tab": ("ctrl+pagedown", False),
    "Last tab": ("ctrl+pageup", False),
    ...
    "Last application": ("alt+tab", False),
    "Next application": ("alt+shift+tab", False),
    "Next window": ("alt+`", False),
    "Last window": ("alt+shift+`", False),
    "Press space key": ("space", False),
    "Press tab key": ("tab", False),    
    "Move up": ("up", False),
    "Move down": ("down", False),
    "Scroll up": ("pageup", False),
    "Scroll down": ("pagedown", False),
}
